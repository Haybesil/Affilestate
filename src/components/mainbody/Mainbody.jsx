      ...
      <>
        <div>
          <div className="relative">
            ...
            <p className="text-[16px] text-primary-Black40  bg-primary-Black30 pl-[2vw] p-[15px]">{prop.sale}</p>
          </div>
          <div className="flex gap-[20px] bg-primary-Black30 px-[2vw]">
            <div className="flex flex-col gap-[5px]">
              ...
              <p className="text-[16px] text-primary-Black50 font-[500]">{prop.address}</p>
              <p className="text-[12px] text-primary-Black40 mb-[23px]">{prop.owner}</p>
            </div>
  ...
  return (
    <>
      <div className="mt-[18vh]">
        <h1 className="text-[16px] font-[700] text-primary-AffilestateBlue60 text-center" data-aos="flip-left"
